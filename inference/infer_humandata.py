"""
Inference script for HumanData (no ground truth).
...
def run_inference(config_name, checkpoint_path, data_dir, output_dir, window_size=8):
    """
    Run MedSAM2 inference on all HumanData NPZ volumes and save visual
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--data_dir", required=True,
                        help="Path to preprocessed HumanData NPZ folder")
