...
class CSNet_3D(nn.Module):
    def __init__(self, num_classes, num_channels):
        ...
        self.enc_input = ResEncoder3d(num_channels, 32)
        self.encoder1 = ResEncoder3d(32, 64)
        self.encoder2 = ResEncoder3d(64, 128)
        self.encoder3 = ResEncoder3d(128, 256)
        self.encoder4 = ResEncoder3d(256, 512)
        self.downsample = downsample()
        self.downsampleV2 = downsampleV2()
        self.affinity_attention = AffinityAttention3d(512)
        self.attention_fuse = nn.Conv3d(512 * 2, 512, kernel_size=1)
        self.decoder4 = Decoder3d(512, 256)
        self.decoder3 = Decoder3d(256, 128)
        self.decoder2 = Decoder3d(128, 64)
        self.decoder1 = Decoder3d(64, 32)
    ...
    def forward(self, x):
        ...
        down1 = self.downsampleV2(enc_input)
